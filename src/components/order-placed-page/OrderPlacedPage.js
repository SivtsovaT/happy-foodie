	...
	return(
		<div className="content">
			...
			<div className="order-wrapper">
				...
				<div className="relax">
					Sit and relax while your orders is being <br/> worked on . It’ll take 5min before you get it
				</div>
				<button onClick={goHome} className="btn btn-295">Go back to home</button>
			</div>
